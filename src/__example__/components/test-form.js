            ...
            <ToolbarButton
              ...
              onClick={() => {
                this.props.setInitialValues({
                  date: 'May 12, 2019 07:34 PM',
                  roll: { index: 1, description: '<p>aergaerg</p>' }
                })
              }}
            />,
            <ToolbarButton
        ...
        >
          <FormSection>
            ...
            <Field
              ...
              component={TextField}
            />
            <Field label='Quill Test' name='quilltest' component={Quill} />
            <Field
              label={'test-roll'}
              name={'roll'}
              component={Roll}
  ...
  renderToolbar() {
    return (
      <div>
        ...
        />
        {!this.state.displaySearch && this.renderTitle()}
      </div>
    )
  }
